...
function sum(a, b) { //eslint-disable-line
  var output = a + b;
  var message = 'The sum of '  + a + b + ' is ' + output + '.'; 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var sumOfFirstTwo = sum(a, b)[0];

  var sumOfAllThree = sum(sumOfFirstTwo, c)[0];

  var multipleOfFirstTwo = multiply(a, b)[0];

  var multipleOfAllThree = multiply(multipleOfFirstTwo, c)[0];

  return [sumOfAllThree, multipleOfAllThree, a + ' and ' + b + ' and ' + c + ' sum to ' + sumOfAllThree + '. ' + 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multipleOfAllThree + '.'];
